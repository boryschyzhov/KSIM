...
Фінальний код моделі та її інтерфейс доступні за [посиланням](WSP.nlogox). Також [посилання](WSPCode.html) на HTML код.
...
Змінний параметр: **sheep-counter** та **vision-radius** 
